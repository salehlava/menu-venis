...
|---|---|
| Menu and prices, add/hide/reorder items and categories | Customer Club member list |
...
Delete a leaked token at https://github.com/settings/tokens — it can only touch the menu repository.
