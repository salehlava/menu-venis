...
import { h, icon, pageHead, button, switchControl, segmented, toast, errorMessage, withBusy } from "../ui.js";
...
export default {
  ...
  async render(root, ctx) {
    ...
    /* ---------- preview ---------- */
    const iframe = h("iframe", { src: `/?lang=${getLang()}`, title: t("preview"), loading: "lazy" });
